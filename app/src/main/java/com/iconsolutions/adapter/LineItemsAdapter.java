...
//            holder.notes = (TextView) convertView.findViewById(R.id.notes_text);
            ...
            holder.requestQtyBtn = (ImageView) convertView.findViewById(R.id.request_qty_button);
...
//                holder.title8.setVisibility(View.VISIBLE);
    ...
    public static class ViewHolder {
        ...
        TextView lineItemName, qunatity, notes, prevInstalledQty, dueItem;
        EditText additionalQty, installedQty, deliveredQty;
        ImageView requestQtyBtn, startStopTime, notesImage;
