...
public class JobImagesFragment extends Fragment{
    ...
    private IMyActivity mainActivity;
        ...
        if(resultCode == getActivity().RESULT_OK && data != null) {
            try {
                if (requestCode == RESULT_LOAD_IMG){
                    ...
                    Log.e("Crew_App","Request  => "+ imgDecodableString.toString());
                    cursor.close();
                    ...
                    Log.e("Crew_App","Request  => "+ imageBitmap.toString());
    ...
    public String uploadDocument(final String picturePath, final Bitmap imageBitmap){
        ...
        p_bar = ProgressDialog.show(fm, getResources().getString(R.string.app_name), "Document Uploading......");
        p_bar.setCanceledOnTouchOutside(false);
...
//                    options.inSampleSize = 2;
                    ...
                    Log.v("JobImagesFragment","Crew_App revdocId => "+revdocId);
    ...
    public void onAttach(Activity activity) {
        ...
        try{
            mainActivity = (IMyActivity)activity;
        }catch(ClassCastException e){
            throw new ClassCastException(activity.toString() +" must be a IMyActivity");
        }
        mainActivity.addFragment(JobImagesFragment.this);
    }
